...
(* Complete the infer function for the new expressions *)
  | Tup (e1, e2) -> raise NotImplemented
  | LetFst (x, e1, e2) -> raise NotImplemented
  | LetSnd (x, e1, e2) -> raise NotImplemented
  | Pre (op, e1) -> raise NotImplemented
                      
  | Yes e -> Maybe (infer ctx e)
  | No t -> Maybe t
  | LetYes (x, e1, e2) -> raise NotImplemented
  | Try (e1, e2) -> raise NotImplemented
...
(* Complete the subst function for the new expressions *) 
  | LetFst (y, e1, e2) -> raise NotImplemented
  | LetSnd (y, e1, e2) -> raise NotImplemented
  | Tup (e1, e2) -> raise NotImplemented
  | Pre (p, e1) -> raise NotImplemented
                     
  | Yes e1 -> raise NotImplemented
  | No _ -> e
  | LetYes (y, e1, e2) -> raise NotImplemented
  | Try (e1, e2) -> raise NotImplemented
